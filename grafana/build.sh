...
cp Dockerfile build
cd build
docker cp $container_id:/gopath1.5/src/github.com/dilgerma/grafana/bin/grafana-server/bin .
docker cp $container_id:/gopath1.5/src/github.com/dilgerma/grafana/public_gen .
